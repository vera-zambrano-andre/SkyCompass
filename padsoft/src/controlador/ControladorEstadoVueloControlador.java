...
import vista.GestionEstadoVueloControlador;
 ...
 */
public class ControladorEstadoVueloControlador implements ActionListener {
    private final VentanaPrincipal frame;
    private final GestionEstadoVueloControlador vista;
     ...
     *                 botón "volver"
     */
    public ControladorEstadoVueloControlador(VentanaPrincipal frame, GestionEstadoVueloControlador vista, SkyCompass app, String anterior) {
        this.frame = frame;
        this.vista = vista;
        this.app = app;
    ...
    private void ejecutarAccion(String metodo) {
        ...
        try {
            switch (metodo) {
                case "asignarVueloHangar":
                    ok = app.asignarVueloHangar(vueloActual);
                    break;
                case "desasignarVueloHangar":
                    ok = app.desasignarVueloHangar(vueloActual);
                    break;
                case "asignarVueloPuertaEmbarque":
                    ok = app.asignarVueloPuertaEmbarque(vueloActual);
                    break;
                case "desasignarVueloPuertaEmbarque":
                    ok = app.desasignarVueloPuertaEmbarque(vueloActual);
                    break;
                case "asignarVueloPistaDespegue":
                    ok = app.asignarVueloPistaDespegue(vueloActual);
                    break;
                case "desasignarVueloPistaDespegue":
                    ok = app.desasignarVueloPistaDespegue(vueloActual);
                    break;
                case "despegarVuelo":
                    ok = app.darSeñalDespegue(vueloActual);
                    break;
                case "asignarPistaAterrizaje":
                    ok = app.asignarVueloPistaAterrizaje(vueloActual);
                    break;
                case "desasignarPistaAterrizaje":
                    ok = app.desasignarVueloPistaAterrizaje(vueloActual);
                    break;
                case "aterrizarVuelo":
                    ok = app.darSeñalAterrizaje(vueloActual);
                    break;
                case "asignarVueloZonaAparcamiento":
                    ok = app.asignarVueloZonaAparcamiento(vueloActual);
                    break;
                case "desasignarVueloZonaAparcamiento":
                    ok = app.desasignarVueloZonaAparcamiento(vueloActual);
                    break;
                case "finalizarVuelo":
                    ok = app.finalizarVuelo(vueloActual);
                    break;
            }
