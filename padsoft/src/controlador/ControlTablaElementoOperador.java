...
/**
 * Clase que representa el controlador de la vista de la tabla de elementos del operador.
 * @author Ruben Bucero Gonzalez
 * @author Xinliang Lin
 * @author Andre Vera Zambrano
 */
public class ControlTablaElementoOperador implements ActionListener {
    private VentanaPrincipal frame;
	private SkyCompass app;
	private TablaElemento vista;

    /** 
     * Constructor de la clase ControlTablaElementoOperador.
     * @param frame ventana principal
     * @param app aplicacion
     * @param vista vista 
     */
    public ControlTablaElementoOperador(VentanaPrincipal frame, SkyCompass app, TablaElemento vista) {
        this.frame = frame;
        this.vista = frame.getTablaElementoOperador(); 
        this.app = app;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (seleccionado) {
            ...
            case "Aerolínea":
                ...
                break;
            case "Tipo de avión":
                vista.mostrarTabla("Tipo de avión", vista.crearTablaTiposAvion(app.getTiposAvionMercancias(), app.getTiposAvionPasajeros()));
                break;
            case "Avión":
                vista.mostrarTabla("Avión", vista.crearTablaAviones(app.getAviones()));
                break;	
        }
