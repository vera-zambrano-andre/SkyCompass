...
/**
 * Clase que representa el controlador de la vista de la tabla de elementos del gestor.
 * @author Ruben Bucero Gonzalez
 * @author Xinliang Lin
 * @author Andre Vera Zambrano
 */
public class ControlTablaElementoGestor implements ActionListener {
    private VentanaPrincipal frame;
	private SkyCompass app;
	private TablaElemento vista;

    /**
     * Constructor de la clase ControlTablaElementoGestor.
     * @param frame ventana principal
     * @param app aplicacion
     * @param vista vista
     */
    public ControlTablaElementoGestor(VentanaPrincipal frame, SkyCompass app, TablaElemento vista) {
        this.frame = frame;
        this.vista = frame.getTablaElementoGestor(); 
        this.app = app;
    }
