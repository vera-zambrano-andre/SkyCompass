 ...
 */
public class GestionEstadoVueloControlador extends JPanel {
     ...
     */
    public GestionEstadoVueloControlador() {
        ...
        String[] acciones = {
            "asignarVueloHangar", "desasignarVueloHangar",
            "asignarVueloPuertaEmbarque", "desasignarVueloPuertaEmbarque",
            "asignarVueloPistaDespegue", "desasignarVueloPistaDespegue",
            "despegarVuelo", "asignarPistaAterrizaje", "desasignarPistaAterrizaje",
            "aterrizarVuelo", "asignarVueloZonaAparcamiento", "desasignarVueloZonaAparcamiento",
            "finalizarVuelo"
        };
