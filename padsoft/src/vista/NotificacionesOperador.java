...
/**
 * Clase que representa la vista de las notificaciones del operador.
 * 
 * @author Ruben Bucero Gonzalez
 * @author Xinliang Lin
 * @author Andre Vera Zambrano
 */
public class NotificacionesOperador extends NotificacionesBase {
    ...
    /**
     * Constructor de la vista de notificaciones para el operador.
     * Inicializa la interfaz con tabla, botón volver y área de contenido.
     * 
     * @param frame Referencia a la ventana principal
     */
    public NotificacionesOperador(VentanaPrincipal frame) {
        this.frame = frame;
        ...
        tablaMensajes.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable tbl, Object val,
                ...
                else if(asunto.toLowerCase().contains("descuento")){
    ...
    /**
     * Actualiza la tabla con la lista de notificaciones recibidas.
     * Limpia el contenido previo y añade nuevas filas con el formato:
